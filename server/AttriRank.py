...
class AttriRank(object):
    ...
    def __init__(self, graph, featureMatrix, adjacency_matrix, itermax=100000,
        ...
        if nodeCount is None:
            self.nodeCount = len(graph.nodes())
        else:
            self.nodeCount = nodeCount

        self.iterationMax = itermax
        self.weighted = weighted
        self.transMat = csr_matrix(adjacency_matrix)
    ...
    def ResetProbVec(self, kernel='rbf_ap'):
        ...
        # print("awehfiuwehfiuhwaeiufhia")
        # print(resetProbVec.shape)
    ...
    def TransMat(self):
        ...
        # print(self.featCount)
        # print(max(rowList))
        # print(max(columnList))
        # print(entryList)
        # transition matrix
        ...
        self.transMat = self.transMat.multiply(csr_matrix(1.0 / self.transMat.sum(axis=0)))
        # print(self.transMat.shape)
        # find dangling nodes
        col_sum = np.array(self.transMat.sum(axis=0))[0]
